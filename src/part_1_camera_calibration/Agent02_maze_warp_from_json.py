...
def Agent02_maze_warp_from_json():
    ap = argparse.ArgumentParser()
    ap.add_argument("--json", default="camera_capture_corners.json", help="Path to corners JSON")
    ap.add_argument("--image", help="Optional override for image path; defaults to 'input' inside JSON, relative to JSON file dir")
    ap.add_argument("--out", default="maze_warp.png", help="Output warped image path")
